package com.djorr.simpleproject.config;

import com.djorr.simpleproject.SimpleProject;
import com.djorr.simpleproject.utils.Color;
...
public class ConfigFile extends YamlConfiguration {
    ...
    public ConfigFile(String name) {
        this.file = new File(SimpleProject.getInstance().getDataFolder(), name);

        if(!this.file.exists()) {
            SimpleProject.getInstance().saveResource(name, false);
        }
